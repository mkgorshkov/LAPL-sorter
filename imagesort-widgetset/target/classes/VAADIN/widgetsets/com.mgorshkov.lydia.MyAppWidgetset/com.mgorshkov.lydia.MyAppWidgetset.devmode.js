...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.com.mgorshkov.lydia.MyAppWidgetset=");
    idx += (13 + "com.mgorshkov.lydia.MyAppWidgetset".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=com.mgorshkov.lydia.MyAppWidgetset-0.js
