...
- imagesort-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- imagesort-ui: main application module, development time
- imagesort-production: module that produces a production mode WAR for deployment
